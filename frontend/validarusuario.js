  // validacion formularios altausuario.html
...
function validarUsuario() {
    ...
    var usuarioValidation = document.getElementById('validarUsuario');
    
    if (usuario.value.length < 2) {
      usuarioValidation.style.color = 'red';
      usuarioValidation.innerHTML = 'Por favor, ingrese un usuario válido. (Minimo 2 caracteres)';
      // usuario.focus();
    } else {
        usuarioValidation.innerHTML = '';
      }
}
